...
describe("Select (composeStories smoke)", () => {
  ...
  test.each([
    ["Default", composed.Default, "Fruit"],
    ["WithGroups", composed.WithGroups, "Food"],
    ["Disabled", composed.Disabled, "Disabled select"],
    ["WithFormField", composed.WithFormField, "Priority"],
  ])("gives the %s trigger an accessible name", (_, Story, name) => {
    render(<Story />);
