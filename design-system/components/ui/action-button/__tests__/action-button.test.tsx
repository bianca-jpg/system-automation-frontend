...
describe("ActionButton (composeStories smoke)", () => {
...
describe("ActionButton contrast contract", () => {
  test("uses the strong semantic foreground on the destructive surface", () => {
    const classes = actionButtonVariants({ variant: "danger" });

    expect(classes).toContain("text-destructive-foreground-strong");
